...
<table  align="center">
	...
	<tr>
	    <td>
	    	<input type="checkbox" name="option" value="total" onClick="toggle(this)"/>
		    <label for="total">전체</label>
	    	<div id="search_box">
<!-- 		      <input type="checkbox" name="option" value="normal"/> -->
<!-- 		      <label for="normal">일반</label> -->
<!-- 		      <input type="checkbox" name="option" value="qna"/> -->
<!-- 		      <label for="qna">Q&A</label> -->
<!-- 		      <input type="checkbox" name="option" value="unknown"/> -->
<!-- 		      <label for="unknown">익명</label> -->
<!-- 		      <input type="checkbox" name="option" value="free"/> -->
